...
import core.dao.DaoImplementacao;
import core.dao.DaoInterface;
...
public class ClienteController extends DaoImplementacao<Cliente> implements DaoInterface<Cliente> {
	 ...
	 */
	  ...
	  * @return JSON String destes registros
	  * @throws Exception
	  */
	...
	/**
	 * Consulta e retorna o registro com o codigo informado
	 * @param codCliente
	 * @return JSON com o registro pesquisado
	 * @throws Exception
	 */
	...
	/**
	 * Consulta e retorna o registro com o nome informado
	 * @param nomeCliente
	 * @return JSON com o registro pesquisado
	 * @throws Exception
	 */
